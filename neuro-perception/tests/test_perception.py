...
from visual.retina import Retina, RetinaOutput, PhotoreceptorType, GanglionCellType
from visual.v1_v2 import V1Processor, V2Processor, V1Output, V2Output
from visual.v4_it import V4Processor, ITProcessor, V4Output, ITOutput, ShapeDescriptor
from visual.dorsal_ventral import DorsalStream, VentralStream, VisualPathways

from auditory.cochlea import Cochlea, CochleaOutput, GammatoneFilterbank
from auditory.a1 import A1Processor, A1Output
from auditory.speech import SpeechProcessor, SpeechOutput, PhonemeRecognizer, FormantTracker, VoicingDetector
...
class TestAttention:
    ...
    def test_attention_gate(self):
        ...
        from multimodal.binding import BoundPercept
        percepts = [
            BoundPercept(
                id="p1",
